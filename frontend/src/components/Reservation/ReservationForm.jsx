    ...
    <form className="reservationD__dates">
      <div>
        ...
        <input
          ...
          value={reservationForm.name}></input>
      ...
      <div>
        ...
        <input
          ...
          value={reservationForm.lastname}></input>
      ...
      <div>
        ...
        <input
          ...
          value={reservationForm.email}></input>
      ...
      <div>
        ...
        <input
          ...
          onChange={handleChange}
          value={reservationForm.phone}></input>
      </div>
      <div id="reservationForm__additionals">
        ...
        <textarea
          ...
          onChange={handleChange}
          value={reservationForm.comentaries}></textarea>
      </div>
      <div id="reservationForm__vaccine">
        <label>
          <input
            ...
            value={reservationForm.covid}></input>
