...
import { imgEye, imgEyeSlash, successIcon, warnIcon } from "../styleAux/fontAwesoneIcon";
...
return (
    <>
      <main>
        {isLoading && <Loader />}
        <div className= {signUpStatusError === false ? "formSignUp" : "errorMessageContainer"}>
          <span className="warning">{warnIcon}</span>
          <p className="errorMessage">Lamentablemente no ha podido registrarse. Por favor intente más tarde</p>
        </div>
        <div className= {signUpSuccessful === false ? "formSignUp" : "successfulMessageContainer"}>
          <span className="warning">{successIcon}</span>
          <p className="successfulMessage">Para terminar su registro debe verificar su cuenta, revise su correo electrónico. 
          Será redirigido al home en unos segundos</p>
        </div>
        <div className="form">
          <h2>Crear cuenta</h2>
          <form className="register" onSubmit={onSubmit}>
            ...
            <div className="register-input">
              <InputComponent
                placeholder={"usuario@digitalhouse.com"}
